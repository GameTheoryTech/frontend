...
const Bank: React.FC = () => {
  ...
  return account && bank ? (
    <>
      ...
      <Alert variant="filled" severity="warning" style={{ marginBottom: '50px' }}>
        {bank.earnTokenName == "GAME" ? "Rewards are not locked for genesis pools so you can immediately start using your GAME." : "The amount of rewards created and locked decreases every week. View the docs for more info."}
      </Alert>
      <Box>
